...
![images](img/square.jpg) **提示**ASP.NET 提供了一个`ActiveDirectoryMembershipProvider`类，尽管这已经超出了本章的范围，但它可以与 ASP.NET 网页一起使用，根据 Windows Active Directory 系统对用户进行身份验证。我们可以在 MSDN 网站上找到更多相关信息:http://msdn . Microsoft . com/en-us/library/system . web . security . activedirectorymembershipprovider . aspx
