...
![images](images/square.jpg) **注意**有关 ASP.NET 网页会员系统中角色使用的更多信息，请参见第 7 章——安全性和会员资格[中的“角色”部分。](07.html#ch7)
...
![images](images/square.jpg) **注**关于添加和删除角色成员的方法的解释，请参见第 7 章-安全性和成员资格[中的“角色”一节。](07.html#ch7)
...
![images](images/square.jpg) **注意**关于 WebGrid 助手及其用法的完整解释可以在[第 6 章](06.html#ch6)——使用数据，在‘使用 WebMatrix 助手显示数据’一节中找到。
...
![images](images/square.jpg) **注意**将该站点部署到面向公众的服务器时，您可能需要更改`ProductImages`文件夹的默认权限，以允许写访问。您的系统管理员或虚拟主机提供商可以帮助您解决这个问题。
...
![images](images/square.jpg) **注意**关于 WebImage 助手及其使用的完整解释可以在[第 12 章](12.html#ch12)-附加技术和特性中找到。
...
![images](images/square.jpg) **注意**文件上的更多信息。存在()和服务器。MapPath()方法可以在 MSDN 网站的以下两个页面中找到:
...
![images](images/square.jpg) **提示**我们在这里为主页生成的动态内容是使用缓存增强性能的主要候选内容。有关使用 WebMatrix 进行缓存的更多信息，请参见[第 12 章](12.html#ch12)附加技术和特性。
