...
但是布拉索不一样。Blazor 基于标准技术，而不是微软技术。您不需要在客户端安装任何东西，因为框架为您提供了您需要使用的一切。NET 核心，利用已经存在的东西。如果你是微软的 web 开发人员，并且不想花时间学习 JavaScript 框架，Blazor 就是你的解决方案。我已经帮助许多公司成功采用了它，它的学习曲线很低，并且允许您重用您的。网核心知识。在这一章中，我们将努力克服你对 JavaScript 的恐惧，让你开始创建你的第一个 Blazor 应用。
