...
![images](img/square.jpg) **注**拖放的最实际应用通常涉及到将内容上传到Web 服务器。例如，您可以使用 Silverlight 拖放功能和文件上传 web 服务的组合，轻松复制 SharePoint 或 SkyDrive 中的多文档上传功能(就像前面“使用 Web 服务传输文件”一节中描述的那样))
