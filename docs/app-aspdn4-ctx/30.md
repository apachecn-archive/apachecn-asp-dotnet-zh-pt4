...
![images](images/3007.jpg)

***图 30-7。**执行远程验证*

![images](images/square.jpg) **注意**与其他验证属性不同，`Remote`属性不在服务器上应用。它仅由不引人注目的客户端验证库使用。这意味着你应该使用我在[第 29 章](29.html#ch29)中展示的技术对值进行明确的检查。
