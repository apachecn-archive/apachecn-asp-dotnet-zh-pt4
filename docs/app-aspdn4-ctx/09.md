...
![images](img/square.jpg) **注意**[清单 9-2 中的其他新元素](#list_9_2) ( `asp:LoginView`、`AnonymousTemplate`、`LoggedInTemplate`、`asp:Menu`和`asp:MenuItem`)是 Web 表单的一部分，我们在[第 13 章](13.html#ch13)中开始研究。
